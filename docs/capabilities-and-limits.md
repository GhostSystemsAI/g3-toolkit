...
| Capability                         | Status  | Notes                                                                                                                                                                                                                              |
| ---------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Incremental layout                 | Shipped | `computeIncrementalUpdate`, `applyIncrementalLayout`, `capturePositions`, and an `IncrementalLayout` class (exported from `@g3t/core/layout`) add and position new nodes without a full re-layout, preserving position stability.         |
